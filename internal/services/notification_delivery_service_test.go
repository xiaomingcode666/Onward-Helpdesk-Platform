...
func setupNotificationDeliveryTestDB(t *testing.T) *gorm.DB {
	...
	if err := db.AutoMigrate(&models.User{}, &models.TenantMember{}, &models.Notification{}, &models.DeliveryLog{}, &models.TenantMailSetting{}, &models.NotificationRecipientSetting{}, &models.MobilePushToken{}, &models.NotificationDeliveryAttempt{}); err != nil {
