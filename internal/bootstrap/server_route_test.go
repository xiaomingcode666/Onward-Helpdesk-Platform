...
func TestNewServerRegistersGinRoutes(t *testing.T) {
	...
	expected := []string{
		...
		http.MethodPost + " /api/enterprise/v1/knowledge-bases/:knowledgeBaseId/documents/:documentId/_submit",
		http.MethodPost + " /api/enterprise/v1/knowledge-bases/:knowledgeBaseId/documents/:documentId/_publish",
		http.MethodPost + " /api/enterprise/v1/knowledge-bases/:knowledgeBaseId/documents/:documentId/_deprecate",
