...
func registerEnterpriseTicketRoutes(group *gin.RouterGroup) {
	...
	group.POST("/tickets/:id/case-owner", require(constants.PermissionTicketView), enterprise.TicketCaseOwnerTransfer)
	group.GET("/tickets/:id/governance", require(constants.PermissionTicketView), enterprise.TicketGovernance)
	group.GET("/ticket-settings/classification", require(constants.PermissionTicketView), enterprise.TicketClassificationPolicy)
	group.GET("/ticket-settings/status-workflow", require(constants.PermissionTicketView), enterprise.TicketStatusWorkflowGet)
	group.POST("/ticket-settings/status-workflow/drafts", require(constants.PermissionTicketUpdate), enterprise.TicketStatusWorkflowDraft)
	group.POST("/ticket-settings/status-workflow/publish", require(constants.PermissionTicketUpdate), enterprise.TicketStatusWorkflowPublish)
